...
import happy from '../componunts/assets/images/happyclient-01.jpg'
import aboutus from '../componunts/assets/images/about-us-image.jpg'
import video from '../componunts/assets/images/video-thumb.jpg'
...
function section(){
  ...
  </div> <div className="video-info section">
    <div className="container">
      <div className="row">
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="section-heading">
            ...
            <div className="line-dec"></div><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doers.</p>
          </div>
        </div>
        <div className="col-lg-12">
          <div className="naccs">
                  ...
                  <ul className="nacc">
                      ...
                      <div>
                        <div className="row">
                          <div className="col-lg-7">
                            ...
                            <div className="line-dec"></div> <p>Tale is the best SEO agency website template using Bootstrap v5.2.2 CSS for your company. It is a free download provided by TemplateMo. There are 3 HTML pages, <a href="index.html">Home</a>, <a href="about.html">About</a>, and <a href="faqs.html">FAQ</a>.</p>
                            <div className="info">
                    ...
                    <li>
                      <div>
                        <div className="row">
                          <div className="col-lg-7">
                            <h4>Detailed Information On What We Do</h4> <div className="line-dec"></div>
                    ...
                    <li>
                      <div>
                        <div className="row">
                          <div className="col-lg-7">
                            <h4>Responsive HTML CSS Templates</h4> <div className="line-dec"></div>
                      ...
                      <div>
                        <div className="row">
                          <div className="col-lg-7">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doers eiusmod kent tempor incididunt ut labore et dolore dolor.</p>
                            <div className="info">
                              <span>Data Analysis</span> <span>SEO Trend</span>
                              <span>Templates</span>
